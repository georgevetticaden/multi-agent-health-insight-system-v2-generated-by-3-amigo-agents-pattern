...
from evaluation.framework.evaluators.cardiology import CardiologyEvaluator

# Import test cases
from evaluation.test_cases.cmo import CMOTestCases
from evaluation.test_cases.cardiology import CardiologyTestCases
...
class EvaluationRunner:
    ...
    def __init__(self):
        ...
        self.evaluator_map = {
            ...
            "cardiology": self._create_cardiology_evaluator
        }
        
        # Map of agent types to test cases
        self.test_case_map = {
            "cmo": CMOTestCases,
            "cardiology": CardiologyTestCases
        }
    ...
    def _create_cardiology_evaluator(self) -> CardiologyEvaluator:
        """Create Cardiology specialist evaluator"""
        # Initialize specialist agent for cardiology
        ...
        return CardiologyEvaluator(specialist_agent, self.anthropic_client)
    
    def get_test_cases(self, agent_type: str, test_type: str, category: Optional[str] = None) -> List[Any]:
        ...
        # Cardiology test cases
            ...
            if test_type == "example":
                return test_cases_class.get_lipid_trend_analysis_cases()[:1]
            elif test_type == "diagnostic":
                return test_cases_class.get_diagnostic_test_suite()
            elif test_type == "treatment":
                return test_cases_class.get_treatment_test_suite()
            elif test_type == "comprehensive":
                return test_cases_class.get_comprehensive_test_suite()
            elif test_type == "real-world":
                return test_cases_class.get_real_world_test_suite()
                ...
                return test_cases_class.get_all_test_cases()
            # Support for category-based filtering (backward compatibility)
    ...
    async def run_evaluation(
        ...
        # Get test cases
        test_cases = self.get_test_cases(agent_type, test_type, category)
    ...
    async def enhance_with_llm_judge_analysis(self, evaluation_result: Dict[str, Any], agent_type: str) -> Dict[str, Any]:
        ...
        for result in evaluation_result.get("results", []):
            ...
            if agent_type == "cmo":
                ...
                enhanced_result = await self._enhance_cardiology_result(enhanced_result)
    ...
    async def _enhance_cardiology_result(self, result: Dict[str, Any]) -> Dict[str, Any]:
        """Enhance Cardiology evaluation result with LLM Judge analysis"""
        # Add cardiology-specific LLM Judge analysis
        # This would use the cardiology prompts we created
        return result
...
async def main():
    ...
    try:
        ...
        # Generate report
        if results.get("results"):
            report_generator = EvaluationReportGenerator(test_dir)
