    ...
    <div className="w-full bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 p-8 overflow-x-auto">
      ...
      <div className="min-w-max mx-auto">
        ...
        <div className="flex items-stretch justify-center gap-8 mb-4">
          {/* Column 1: Product Owner Input */}
          <div className="bg-gradient-to-b from-yellow-500/20 to-orange-500/20 rounded-xl p-6 border border-yellow-500/30 w-80" style={{ minHeight: '360px' }}>
          ...
          {/* Column 2: PM Agent */}
          <div className="bg-gradient-to-b from-blue-500/20 to-cyan-500/20 rounded-xl p-6 border border-blue-500/30 w-80" style={{ minHeight: '360px' }}>
            <div className="text-center mb-4">
          ...
          {/* Column 3: UX Agent */}
          <div className="bg-gradient-to-b from-purple-500/20 to-pink-500/20 rounded-xl p-6 border border-purple-500/30 w-80" style={{ minHeight: '360px' }}>
            <div className="text-center mb-4">
        ...
        {/* Arrows pointing down with labels - aligned with boxes above */}
        <div className="flex items-start justify-center gap-8 mb-4" style={{ marginTop: '-10px' }}>
          {/* Arrow under Product Owner - moved more left */}
          ...
          {/* Arrow under UX Agent - moved more right */}
        ...
        {/* Bottom Row: Claude Code matching width of 3 boxes above */}
        <div className="flex justify-center">
          <div className="bg-gradient-to-b from-green-500/20 to-emerald-500/20 rounded-xl p-6 border border-green-500/30 mb-8" style={{ width: '74rem' }}>
