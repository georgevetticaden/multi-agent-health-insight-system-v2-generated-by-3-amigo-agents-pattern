    ...
    def get_simple_queries() -> List[TestCase]:
        ...
        return [
            ...
            TestCase(
                ...
                expected_complexity="SIMPLE",
                expected_specialties={"nutrition"},
    ...
    def get_standard_queries() -> List[TestCase]:
        ...
        return [
            ...
            TestCase(
                ...
                expected_complexity="STANDARD",
                expected_specialties={"cardiology", "preventive_medicine"},
    ...
    def get_complex_queries() -> List[TestCase]:
        ...
        return [
            TestCase(
                ...
                expected_specialties={"pharmacy", "cardiology", "laboratory_medicine", "endocrinology"},
            ...
            TestCase(
                ...
                expected_complexity="COMPLEX",
                expected_specialties={"cardiology", "endocrinology", "preventive_medicine", "pharmacy"},
            ...
            TestCase(
                ...
                expected_complexity="COMPLEX",
                expected_specialties={"laboratory_medicine", "endocrinology", "pharmacy", "preventive_medicine"},
    ...
    def get_comprehensive_queries() -> List[TestCase]:
        ...
        return [
            TestCase(
                ...
                expected_specialties={"endocrinology", "cardiology", "pharmacy", 
                                    "laboratory_medicine", "nutrition", "preventive_medicine"},
    ...
    def get_edge_cases() -> List[TestCase]:
        ...
        return [
            TestCase(
                ...
                expected_complexity="SIMPLE",
                expected_specialties={"laboratory_medicine", "cardiology"},
            ...
            TestCase(
                ...
                expected_complexity="STANDARD",
                expected_specialties={"cardiology", "laboratory_medicine"},
            ...
            TestCase(
                ...
                query="health",
                expected_complexity="SIMPLE",
                expected_specialties={"preventive_medicine"},
            ...
            TestCase(
                ...
                expected_complexity="STANDARD",
                expected_specialties={"endocrinology", "nutrition"},
